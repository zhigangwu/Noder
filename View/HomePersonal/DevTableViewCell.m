...
- (void)configWithItem:(DevDataModel *)devModel{
    ...
    self.titleLabel.text = devModel.title;
...
//    self.lineBreakMode = NSLineBreakByTruncatingTail;
    ...
    [self.image_view sd_setImageWithURL:devModel.author.avatar_url];
    
    
    NSString *dateStr = devModel.last_reply_at;
    ...
    self.watchLabel.text = [NSString stringWithFormat:@"%@",devModel.visit_count];
    self.messageLabel.text = [NSString stringWithFormat:@"%@",devModel.reply_count];
}
@end
